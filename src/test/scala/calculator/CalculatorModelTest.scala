...
class CalculatorModelTest extends FunSuite {
  ...
  def getReportingPeriods() {
    ...
    val reportingPeriods = Calculator(dr).reportingPeriods
  ...
  def getReportingPeriods_preCutoff() {
    ...
    val reportingPeriods = calculatorModel.reportingPeriods
    assertEquals(2, reportingPeriods.size)
  ...
  def getReportingPeriods_AndFebruary() {
    val reportingPeriods = Calculator(DateRange(new LocalDate(2017, 9, 1), new LocalDate(2018, 8, 31))).reportingPeriods
    assertEquals(2, reportingPeriods.size)
  ...
  def getReportingPeriods_9MonthYear() {
    val reportingPeriods = Calculator(DateRange(new LocalDate(2018, 1, 1), new LocalDate(2018, 9, 30))).reportingPeriods
  ...
  def getReportingPeriods_15MonthYear() {
    val reportingPeriods = Calculator(DateRange(new LocalDate(2018, 1, 1), new LocalDate(2019, 3, 31))).reportingPeriods
    assertEquals(2, reportingPeriods.size)
    assertPeriod(reportingPeriods(0), "1 January 2018", "30 June 2018", "30 July 2018")
  ...
  def getReportingPeriods_15MonthYearPlus() {
    val reportingPeriods = Calculator(DateRange(new LocalDate(2018, 1, 1), new LocalDate(2019, 4, 1))).reportingPeriods
  ...
  def getReportingPeriods_19MonthYear() {
    val reportingPeriods = Calculator(DateRange(new LocalDate(2018, 1, 1), new LocalDate(2019, 9, 30))).reportingPeriods
    assertEquals(3, reportingPeriods.size)
    assertPeriod(reportingPeriods(0), "1 January 2018", "30 June 2018", "30 July 2018")
    assertPeriod(reportingPeriods(1), "1 July 2018", "31 December 2018", "30 January 2019")
  ...
  def getReportingPeriods_19MonthYearPlus() {
    val reportingPeriods = Calculator(DateRange(new LocalDate(2018, 1, 1), new LocalDate(2019, 10, 1))).reportingPeriods
    assertEquals(3, reportingPeriods.size)
    assertPeriod(reportingPeriods(0), "1 January 2018", "30 June 2018", "30 July 2018")
    assertPeriod(reportingPeriods(1), "1 July 2018", "31 December 2018", "30 January 2019")
  ...
  def getReportingPeriods_StartingMarch() {
    val reportingPeriods = Calculator(DateRange(new LocalDate(2018, 3, 1), new LocalDate(2019, 2, 28))).reportingPeriods
    assertEquals(2, reportingPeriods.size)
  ...
  def getReportingPeriods_24MonthYear_StartingEndOfMonthHittingEndOfFebruary() {
    val reportingPeriods = Calculator(DateRange(new LocalDate(2017, 8, 31), new LocalDate(2019, 8, 30))).reportingPeriods
    assertEquals(3, reportingPeriods.size)
  ...
  def getReportingPeriods_forAges() {
    val reportingPeriods = Calculator(DateRange(new LocalDate(2018, 1, 1), new LocalDate(3018, 1, 1))).reportingPeriods
  ...
  def getReportingPeriods_forBadDates() {
    assertEquals(0, Calculator(DateRange(new LocalDate(2018, 1, 1), new LocalDate(2018, 1, 1))).reportingPeriods.size)
    assertEquals(0, Calculator(DateRange(new LocalDate(2018, 1, 1), new LocalDate(2017, 1, 1))).reportingPeriods.size)
    assertEquals(0, Calculator(DateRange(new LocalDate(2018, 2, 40), new LocalDate(2019, 1, 1))).reportingPeriods.size)
  }
