...
object ValidationsTestData {
  ...
  val test1 = Map(
    ...
    "paymentStatistics.averageDaysToPay" -> "33",
    "paymentStatistics.percentPaidLaterThanAgreedTerms" -> "33",
    "paymentStatistics.percentageSplit.percentWithin30Days" -> "33",
    "paymentStatistics.percentageSplit.percentWithin60Days" -> "33",
    "paymentStatistics.percentageSplit.percentBeyond60Days" -> "33",
