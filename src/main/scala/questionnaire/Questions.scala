...
object Questions {
  ...
  val companyBalanceSheetQuestionY2 = YesNoQuestion("companyThresholds.balanceSheet", "question.company.balance.y2", balanceHint)
  ...
  val companyBalanceSheetQuestionY3 = YesNoQuestion("companyThresholds.balanceSheet", "question.company.balance.y3", balanceHint)
  ...
  val subsidiaryTurnoverQuestionY2 = YesNoQuestion("subsidiaryThresholds.turnover","question.subsidiaries.turnover.y2", subsidiariesThresholdHint)
  val subsidiaryBalanceSheetQuestionY2 = YesNoQuestion("subsidiaryThresholds.balanceSheet","question.subsidiaries.balance.y2", subsidiariesThresholdHint)
  ...
  val subsidiaryTurnoverQuestionY3 = YesNoQuestion("subsidiaryThresholds.turnover","question.subsidiaries.turnover.y3", subsidiariesThresholdHint)
  val subsidiaryBalanceSheetQuestionY3 = YesNoQuestion("subsidiaryThresholds.balanceSheet","question.subsidiaries.balance.y3", subsidiariesThresholdHint)
