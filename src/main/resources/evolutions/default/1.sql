...
create index "reportperiod_report_idx" on "report_period" ("report_id");
...
create index "paymentterms_report_idx" on "payment_terms" ("report_id");
...
create index "otherinfo_report_idx" on "other_info" ("report_id");
create table "filing" ("report_id" BIGINT NOT NULL,"filing_date" date NOT NULL,"approved_by" VARCHAR(255) NOT NULL);
create index "filing_report_idx" on "filing" ("report_id");
