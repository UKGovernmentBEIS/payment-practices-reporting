...
create unique index "long_form_report_idx" on "long_form" ("report_id");
...
alter table "long_form" add constraint "long_form_report_fk" foreign key("report_id") references "short_form"("report_id") on update NO ACTION on delete CASCADE;
...
alter table "long_form" drop constraint "long_form_report_fk";
drop table "session";
